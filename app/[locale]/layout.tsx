      ...
      <body className="min-h-full bg-bg-deep text-text-soft">
        <NextIntlClientProvider messages={messages}>
          <PostHogProvider>
            ...
            <footer className="mt-24 py-12 px-4 md:px-10 text-center text-xs text-text-mute">
              ...
              <p className="text-text-dim">Romance stories you can listen, watch and read.</p>
              <p className="mt-2 text-gold-deep tracking-widest uppercase text-[10px] font-bold">
                alluretv.net
              </p>
              <p className="mt-4 opacity-60">© 2026 AllureTV — All rights reserved.</p>
            </footer>
          </PostHogProvider>
